---
title: Querying Move Contract Data with Dubhe SDK
description: Learn how to query Move contract data using the Dubhe SDK with automatic BCS parsing and type-safe interactions
---
