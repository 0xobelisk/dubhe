...
- ✅ Tooling gates in `test-audit`:
  ...
  - local diagnostics artifacts: gas profile HTML/JSON, regression hotspot JSON, flamegraph SVG, debug replay smoke
  - best-effort RPC diagnostics artifacts: fork fixture drift report + trace markdown/HTML + call-graph report
