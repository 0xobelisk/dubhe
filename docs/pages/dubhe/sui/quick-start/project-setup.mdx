...
At this point you will see the option of choosing a template—as of writing the three options are **101**, **nextjs**, **contract**.
...
Once the dev server is running, open `http://localhost:3000` in your browser to view the app.
