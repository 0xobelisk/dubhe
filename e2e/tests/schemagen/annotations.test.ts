 ...
 *   - keys: [...]       → mint (caller-provided keys) + existence checks
...
describe('Schemagen: resource annotations', () => {
  ...
  it('keys: [...] — generates mint (caller-provided keys) and existence checks', async () => {
    const config = defineConfig({
      name: 'mygame',
      description: 'test',
      resources: {
  ...
  // ── transferable: true (keyed) + objects.accepts ─────────────────────────────

  it('transferable keyed resource accepted by an object — generates transfer_user_to_<obj> and transfer_<obj>_to_user', async () => {
    const config = defineConfig({
      name: 'mygame',
      description: 'test',
      resources: {
  ...
  it('listable: true (keyed) — generates list, buy, cancel_listing, expire_listing entry fns', async () => {
    const config = defineConfig({
      name: 'mygame',
      description: 'test',
      resources: {
