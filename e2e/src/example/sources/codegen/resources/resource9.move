  ...
  module example::resource9 { 
    ...
    public fun get_name(dapp_hub: &DappHub, resource_account: String, player: address): vector<String> {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public(package) fun set_name(dapp_hub: &mut DappHub, resource_account: String, player: address, name: vector<String>, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public fun get_age(dapp_hub: &DappHub, resource_account: String, player: address): u32 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public(package) fun set_age(dapp_hub: &mut DappHub, resource_account: String, player: address, age: u32, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String, player: address): (vector<String>, u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, player: address, name: vector<String>, age: u32, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
    ...
    public fun get_struct(dapp_hub: &DappHub, resource_account: String, player: address): Resource9 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        let value_tuple = dapp_system::get_record<DappKey>(dapp_hub, resource_account, key_tuple);
    ...
    public(package) fun set_struct(dapp_hub: &mut DappHub, resource_account: String, player: address, resource9: Resource9, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
