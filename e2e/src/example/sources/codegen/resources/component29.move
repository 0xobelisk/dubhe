  ...
  module example::component29 { 
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String): (vector<address>) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, value: vector<address>, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
