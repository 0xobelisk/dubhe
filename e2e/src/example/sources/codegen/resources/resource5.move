...
module example::resource5 {
    ...
    public fun has(user_storage: &UserStorage, player: address, id: u32): bool {
    ...
    public fun ensure_has(user_storage: &UserStorage, player: address, id: u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public fun ensure_has_not(user_storage: &UserStorage, player: address, id: u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public(package) fun delete(user_storage: &mut UserStorage, player: address, id: u32, ctx: &TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public fun get(user_storage: &UserStorage, player: address, id: u32): u32 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public(package) fun set(user_storage: &mut UserStorage, player: address, id: u32, value: u32, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public(package) fun mint(
        ...
        player: address, id: u32, value: u32,
        ctx: &mut TxContext,
    ) {
        ensure_has_not(user_storage, player, id);
        set(user_storage, player, id, value, ctx);
    }
}