  ...
  module example::resource5 { 
    ...
    public fun has(dapp_hub: &DappHub, resource_account: String, player: address, id: u32): bool {
    ...
    public fun ensure_has(dapp_hub: &DappHub, resource_account: String, player: address, id: u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public fun ensure_has_not(dapp_hub: &DappHub, resource_account: String, player: address, id: u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public(package) fun delete(dapp_hub: &mut DappHub, resource_account: String, player: address, id: u32) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String, player: address, id: u32): u32 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, player: address, id: u32, value: u32, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player));
        key_tuple.push_back(to_bytes(&id));
