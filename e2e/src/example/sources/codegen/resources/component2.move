...
module example::component2 {
    ...
    public(package) fun set(user_storage: &mut UserStorage, player_id: u32, value: bool, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&player_id));
    ...
    public(package) fun mint(
        ...
        player_id: u32, value: bool,
        ctx: &mut TxContext,
    ) {
        ensure_has_not(user_storage, player_id);
        set(user_storage, player_id, value, ctx);
    }
}