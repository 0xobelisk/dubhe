  ...
  module example::component26 { 
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String): (vector<u64>) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, value: vector<u64>, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
