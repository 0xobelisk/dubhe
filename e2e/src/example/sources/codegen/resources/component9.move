...
module example::component9 {
    ...
    public fun get(user_storage: &UserStorage): Direction {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public(package) fun set(dapp_hub: &DappHub, user_storage: &mut UserStorage, value: Direction, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
