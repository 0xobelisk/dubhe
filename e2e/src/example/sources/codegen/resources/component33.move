  ...
  module example::component33 { 
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String): (vector<String>) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, value: vector<String>, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
