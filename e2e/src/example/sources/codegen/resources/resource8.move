  ...
  module example::resource8 { 
    ...
    public fun get(dapp_hub: &DappHub, resource_account: String): (address, String) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public(package) fun set(dapp_hub: &mut DappHub, resource_account: String, player: address, name: String, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
    ...
    public fun get_struct(dapp_hub: &DappHub, resource_account: String): Resource8 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        let value_tuple = dapp_system::get_record<DappKey>(dapp_hub, resource_account, key_tuple);
        decode(value_tuple)
    ...
    public(package) fun set_struct(dapp_hub: &mut DappHub, resource_account: String, resource8: Resource8, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
