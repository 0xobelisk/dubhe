...
module example::arena_permit {
    ...
    public struct ArenaPermit has copy, drop {}

    public fun meta(permit: &dubhe::dapp_service::ScenePermit<ArenaPermit>): &dubhe::dapp_service::PermitMetadata {
        dapp_service::scene_permit_meta(permit)
    }

    public fun is_active(permit: &dubhe::dapp_service::ScenePermit<ArenaPermit>, now_ms: u64): bool {
        dapp_service::is_scene_active(dapp_service::scene_permit_meta(permit), now_ms)
    }

    public fun is_participant(permit: &dubhe::dapp_service::ScenePermit<ArenaPermit>, addr: address): bool {
        dubhe::dapp_system::is_scene_permit_participant<ArenaPermit>(permit, addr)
    }

    public(package) fun new_arena_permit(
        dapp_storage:     &DappStorage,
        participants:     vector<address>,
        expires_at:       std::option::Option<u64>,
        max_participants: std::option::Option<u64>,
        ctx:              &mut TxContext,
    ): dubhe::dapp_service::ScenePermit<ArenaPermit> {
        dubhe::dapp_system::new_scene_permit<DappKey, ArenaPermit>(
            dapp_key::new(), dapp_storage, PERMIT_TYPE, participants, expires_at, max_participants, ctx
        )
    }

    public(package) fun new_arena_permit_with_invitations(
        dapp_storage:      &DappStorage,
        ...
        dubhe::dapp_system::new_scene_permit_with_invitations<DappKey, ArenaPermit>(
            dapp_key::new(), dapp_storage, PERMIT_TYPE, invitees, invites_expire_at, scene_expires_at, max_participants, ctx
        )
    }

    public(package) fun share_arena_permit(permit: dubhe::dapp_service::ScenePermit<ArenaPermit>) {
        dubhe::dapp_system::share_scene_permit<DappKey, ArenaPermit>(
            dapp_key::new(), permit
        );
    }

    public(package) fun create_arena_permit(
        dapp_storage:     &DappStorage,
        participants:     vector<address>,
        expires_at:       std::option::Option<u64>,
        max_participants: std::option::Option<u64>,
        ...
        dubhe::dapp_system::create_and_share_scene_permit<DappKey, ArenaPermit>(
            dapp_key::new(), dapp_storage, PERMIT_TYPE, participants, expires_at, max_participants, ctx
        );
    }

    public(package) fun create_arena_permit_with_invitations(
        dapp_storage:      &DappStorage,
        invitees:          vector<address>,
        invites_expire_at: std::option::Option<u64>,
        scene_expires_at:  std::option::Option<u64>,
        ...
        dubhe::dapp_system::create_and_share_scene_permit_with_invitations<DappKey, ArenaPermit>(
            dapp_key::new(), dapp_storage, PERMIT_TYPE, invitees, invites_expire_at, scene_expires_at, max_participants, ctx
        );
    }
    ...
    public(package) fun expire_arena_permit(
        permit: dubhe::dapp_service::ScenePermit<ArenaPermit>,
        ctx:    &TxContext,
    ) {
        assert!(
        ...
        dubhe::dapp_system::destroy_scene_permit<DappKey, ArenaPermit>(
            dapp_key::new(), permit
        );
    }
}
