...
/// Demonstrate non-global resource operations stored in UserStorage.
public entry fun resources(user_storage: &mut UserStorage, ctx: &mut TxContext) {
    ...
    // keyed resources: player as explicit key
...
/// Demonstrate component-style resources (no explicit keys → entity-id from keys).
