...
module counter::counter2withkey {
    ...
    public fun has(user_storage: &UserStorage, data: u64, key: String): bool {
    ...
    public fun ensure_has(user_storage: &UserStorage, data: u64, key: String) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&data));
        key_tuple.push_back(to_bytes(&key));
    ...
    public fun ensure_has_not(user_storage: &UserStorage, data: u64, key: String) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&data));
        key_tuple.push_back(to_bytes(&key));
    ...
    public(package) fun delete(user_storage: &mut UserStorage, data: u64, key: String, ctx: &TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&data));
        key_tuple.push_back(to_bytes(&key));
    ...
    public fun get(user_storage: &UserStorage, data: u64, key: String): u32 {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&data));
        key_tuple.push_back(to_bytes(&key));
    ...
    public(package) fun set(dapp_hub: &DappHub, user_storage: &mut UserStorage, data: u64, key: String, value: u32, ctx: &mut TxContext) {
        let mut key_tuple = vector::empty();
        key_tuple.push_back(TABLE_NAME);
        key_tuple.push_back(to_bytes(&data));
        key_tuple.push_back(to_bytes(&key));
